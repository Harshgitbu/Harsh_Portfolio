...
const experiences = [
  {
    ...
    details: [
      'Led AI driven funding automation platform reducing approval TAT from 24 hours to under 7 minutes for financing workflows.',
      'Engineered ML-powered offer generation and underwriting pipelines integrating internal pricing and AI decision systems.',
      'Integrated Salesforce, Onfido, Experian, Equifax, DataMerch, and CLEAR APIs automating onboarding, verification, and risk evaluation.',
      'Built FastAPI, Python, and PostgreSQL backend services enabling automated lead ingestion, decisioning, and funding workflows.',
      'Contributed to enterprise AI initiative using Cursor, Claude, and cloud automation tools improving deployment efficiency and scalability.',
    ],
    tech: ['Python', 'MLOps', 'Docker', 'LLM Applications', 'CI/CD', 'FastAPI', 'AWS', 'Terraform'],
